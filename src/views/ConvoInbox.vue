        ...
        <b-card class="mt-5" header-class="border" body-class="bcard">
          <div class="row">
            <div class="col mb-3" v-if="this.getPrevPage !== null">
              <b-button class="addCommentBtn" @click="toggleMessage" >See older Messages</b-button>
            </div>
          </div>
          
           <div v-for="(comment, key) in getComment" :key="comment.id" :class="{'color': comment.user_to !== 'super_admin'}" class="mt-5">
         ...
         <img :src="commentImg"  class="mt-4" height="500px" width="465px"/>
          ...
          <div class="row mt-5">
            <div class="col-md-12 col-h">
              ...
              <textarea class="innershadow form-control" rows="5" v-model="comments.newComment"></textarea>
              <br />
            </div>
             </div>
             <div class="row">
            <div class="col-5 mb-4 ml-3">
              <b-form-file class="custom-file-label" id="uploadFile" v-model="file" placeholder="Choose a file">
              </b-form-file>
              
            </div>
              <div class="col">
                <b-button
                class="ml-3 addCommentBtn"
                size="sm"
                @click="addComment"
  ...
  methods: {
    ...
    toggleMessage(){
     ...
     viewImage(comment){
      ...
      //   this.loadComment = comment.file_path
    ...
    addComment() {
      ...
      formData.append("accountTo", this.id);
       ...
       if(fileElement.value.lastIndexOf(".") > 0){
        ...
        else if(fileExtension.toLowerCase() == "jpg" || fileExtension.toLowerCase() == "jpeg" || fileExtension.toLowerCase() == "png" || fileExtension.toLowerCase() == "zip" || fileExtension.toLowerCase() == "pdf" || fileExtension.toLowerCase() == "rar" || fileExtension.toLowerCase() == "" ){
